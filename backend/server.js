...
const LOGIC_QUESTIONS = [
    ...
    {
        question: "If 3 × 4 = 25 and 4 × 5 = 41, then 5 × 6 = ?",
        options: ["61", "65", "71", "75"],
        correct: "A"
    },
    {
    ...
    {
        question: "If 8 → 64 and 9 → 81, then 7 → ?",
        options: ["42", "48", "49", "56"],
        correct: "C"
    },
    {
    ...
    {
        question: "If 10 → 100, 5 → 25, then 8 → ?",
        options: ["56", "60", "64", "72"],
        correct: "C"
    },
    {
...
app.post('/api/submit-test', (req, res) => {
    ...
    db.query(query, [user_email, user_name, score, total_questions, topic, time_spent, percentage], 
        (err, result) => {
            ...
            console.log(`✅ Test result saved: ${user_email} scored ${score}/${total_questions}`);
        ...
        async (err, result) => {
            ...
            try {
                ...
                if (emailResult.success) {
                    console.log(`📧 Result email sent to: ${user_email}`);
                } else {
